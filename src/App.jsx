...
import { getFavCart } from "./rtc/slices/FavCartSlice";
...
function App() {
	...
	const favCartData = useSelector(state => state.favCartReducer.favCart)
	console.log(favCartData);
		...
		<>
			<BrowserRouter>
				...
				<Routes>
					...
					<Route path="ChangePassReset" element={<ChangePassReset/>} />
					<Route
						path="Register"
						element={
							<>
